...
4. Подключитесь к серверу:
   ...
   - Введите строку подключения в формате: `ssh логин@ip-адрес`. Например: `ssh boss@192.168.1.35`. **Конкретные данные** для подключения смотрите в [moodle](https://moodle.cfuv.ru/mod/assign/view.php?id=787770);
